...
Helper UI for Home Assistant: a **group of template and combine sensors** recalculated **together**, **in order**, either every X seconds or when a source entity changes.
